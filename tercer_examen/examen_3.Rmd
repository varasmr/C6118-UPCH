...
El evento del NiÃ±o de 1982-83 fue calificado de intensidad extraordinaria, con un incremento de la Temperatura Superficial del Mar (SST, por sus siglas en inglÃ©s) frente a la costa norte del PerÃº de hasta de 10Â° celsius (MINAM, 2014). Las condiciones oceanogrÃ¡ficas posteriores a dicho evento son de particular interÃ©s para saber en quÃ© momento la productividad primaria se reestableciÃ³ en las costas del PerÃº respecto a aÃ±os anteriores al evento. Debido a ello, en este trabajo se comparan dos parÃ¡metros: la SST y la productividad primaria entre los aÃ±os 1978-1981 y 1984-1987.


## Materiales y métodos

Se usÃ³ la base de datos de parÃ¡metros oceanogrÃ¡ficos del Max-Plank-Institut fÃ¼r Meteorologie (proporcionado por Oliveros-Ramos, com. pers., 2017) que contienen datos de la Temperatura Superficial del Mar (SST), Salinidad (SSS), integración vertical de la producción de fitoplankton pequeÃ±o (sphy) y grande (lsphy) y pH, desde 1959 hasta el 2005 (representada en 552 meses). Se seleccionaron los meses correspondientes a enero-diciembre de en el lapso de 1978-1981 (228-275), 1982 (276), 1983 (288-299), 1984 (300-311), 1985 (312-323) y 1987 (336-347) para las comparaciones respectivas. Los datos fueron trabajados en el software R (Ver. 3.4.0). Se instalaron los paquetes Fields, Maps, ncdf4, Kali para la obtención de los gráficos.

Las anomalías de la SST se obtuvieron mediante la diferencia entre el valor de la SST promedio de los rangos mencionados y el aÃ±o estudiado.
...
La SST para el aÃ±o de El Niño 1982-83 se muestra a continuación:
...
image.plot(lon,lat,clim[,,i], main="ClimatologÃ­a del aÃ±o 1982 (Â°C)",xlab="longitud", ylab="latitud")
...
Para el caso de la variaciÃ³n de la SST respecto al SST promedio visto entre 1978-1981, se muestra a continuaciÃ³n en la figura 2:
