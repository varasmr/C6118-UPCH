...
lphy8186=apply(lphy[,,264:335], MARGIN = c(1,2), FUN = mean, na.rm = TRUE)
sphy8186=apply(sphy[,,264:335], MARGIN = c(1,2), FUN = mean, na.rm = TRUE)
...
plot(time4,meanphy, type="l", col="blue",las=3, xlab="meses",ylab="PP (mol C m-2*s-1)", main = "Producción Primaria durante el Niño")
abline(v=c(276,299),lty=4)
