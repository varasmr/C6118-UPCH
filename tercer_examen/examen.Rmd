...
La SST para el año de El Niño 1982-83 se muestra a continuación
...
image.plot(lon,lat,clim[,,i], main="Climatología del año 1982",xlab="longitud", ylab="latitud")
...
image.plot(lon,lat,clim[,,i], main="Climatología del año 1983",xlab="longitud", ylab="latitud")
...
image.map(lon, lat, sst_mean, main = "SST promedio entre 1981-1986 (°C)")
...
lphy8186=lphy[264:335]
sphy8186=sphy[264:335]
totalphy=lphy8186+sphy8186
meanphy=apply(totalphy, MARGIN = c(1,2), FUN=mean)
time4=c(264:335)
plot(time4,totalphy, type="l", col="blue",las=3, xlab="meses",ylab="PP (mol C m-2*s-1)", main = "Producción Primaria durante el Niño")
abline(v=c(276,299),lty=4)
